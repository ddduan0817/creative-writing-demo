        ...
        <div className="bg-white rounded-2xl shadow-2xl border border-gray-100 p-8 max-w-md w-full mx-4">
          ...
          <div className="flex gap-3">
            ...
            >
              ...
              <p className="text-[11px] text-gray-400 mt-2 leading-relaxed">{isScreenplay ? "通过 AI 对话完成灵感→设定→角色→集纲→逐集创作的流程" : "通过 AI 对话完成灵感→设定→角色→大纲→正文的创作流程"}</p>
            </button>
              ...
              currentRound === 4
                ...
                ? scene === "marketing"
                  ...
                  ? currentRound === -2
                    ...
                    : currentRound === 23
                    ? "想调整什么？直接说就行..."
                    : "想拆书、解读内容还是写知识文章？告诉我你的需求..."
                  : isScreenplay
                  ? "描述你的故事构思，比如「霸总追妻」「都市悬疑复仇」，或上传小说改编..."
